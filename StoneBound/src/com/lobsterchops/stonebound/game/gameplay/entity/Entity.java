...
public abstract class Entity implements Renderable {
	 ...
	 *
	 * <p>
	 * Implementors must NOT call {@code renderer.getRaw().dispose()} and must NOT
	 * store the renderer reference beyond this call.
	 *
	...
	/**
	 * Returns {@link RenderLayerKey#ENTITIES} by default. Override in subclasses
	 * that need a different layer.
	 */
	@Override
